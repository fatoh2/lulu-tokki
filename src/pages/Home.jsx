  ...
  return (
    <div>
      ...
      <div style={{
        ...
        <div style={{ position: 'absolute', top: '30%', left: '6%', fontSize: 44, opacity: 0.12, pointerEvents: 'none' }}>🍜</div>
        <div style={{ position: 'absolute', bottom: '20%', right: '8%', fontSize: 44, opacity: 0.12, pointerEvents: 'none' }}>🍬</div>
        <div style={{ position: 'absolute', top: '20%', right: '12%', fontSize: 36, opacity: 0.12, pointerEvents: 'none' }}>🥤</div>
        <div style={{ position: 'absolute', bottom: '35%', left: '15%', fontSize: 32, opacity: 0.12, pointerEvents: 'none' }}>🍪</div>

        <div style={{ position: 'relative', zIndex: 1, maxWidth: 720 }}>
          <div style={{ fontSize: 64, marginBottom: 18, lineHeight: 1 }}>🇰🇷</div>
          <h1 style={{ color: 'white', fontSize: 38, fontWeight: 900, margin: '0 0 18px', lineHeight: 1.25 }}>
            {t('heroTitle')}
          </h1>
          <p style={{ color: 'rgba(255,255,255,0.88)', fontSize: 17, lineHeight: 1.75, marginBottom: 40, maxWidth: 560, marginInline: 'auto' }}>
            {t('heroSubtitle')}
          </p>
          ...
          {/* Stats */}
          <div style={{ display: 'flex', gap: 36, justifyContent: 'center', marginTop: 52, flexWrap: 'wrap', borderTop: '1px solid rgba(255,255,255,0.15)', paddingTop: 36 }}>
            {[
